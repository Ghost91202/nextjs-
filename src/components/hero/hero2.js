    ...
    <div className=''>
      <section className={`bg-center bg-no-repeat bg-[url('https://flowbite.s3.amazonaws.com/docs/jumbotron/conference.jpg')] bg-gray-700 ${blendModeClass} transition-all duration-1000`}>
        <div className="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
          ...
          <p className="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-16 lg:px-48">Here at PieBond we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
