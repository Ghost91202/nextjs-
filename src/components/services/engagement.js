    ...
    return (
        <div className="lg:pb-10 lg:h-2xl lg:p-20">
            ...
            <div className="bg-slate-400 flex flex-col lg:gap-10  p-5 rounded-2xl">
                ...
                <img src="https://images.unsplash.com/photo-1584583528653-966964d48bf1?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NDN8fGJ1aWxkaW5ncyUyMDklM0ExNnxlbnwwfHwwfHx8MA%3D%3D" alt="" className="
