...
const HoverButton = ( { title, link1, link2, link3, link4, link5, link6, link7, link8, link9, link10, link11, link12, link13, link14, link15, link16, link17, link18, menu1, menu2, menu3, menu4, menu5, menu6,  menu7,  menu8,  menu9,  menu10,  menu11, menu12, menu13, menu14, menu15, menu16, menu17, menu18, desc1, desc2, desc3, desc4, desc5, desc6, desc7, desc8, desc9, desc10, desc11, desc12, desc13, desc14, desc15, desc16, desc17, desc18} ) => {
                    ...
                    <div className={styles.drawer}>
                        <div className="flex  h-auto w-screen overflow-hidden p-10 bg-black text-white grid-flow-row ">
                            ...
                            <div>
                                {isValidLink7 ? (
                                    <div className=" text-blue-600 border-b pb-3 w-fit flex items-center lg:text-xl font-semibold ">
                                        <Link href={link7}>{menu7}</Link><IoIosArrowRoundForward />
                                    </div>
                                ) : (
                            ...
                            <div>
                                {isValidLink8 ? (
                                    <div className=" text-blue-600 border-b pb-3 w-fit flex items-center lg:text-xl font-semibold ">
                                        <Link href={link8}>{menu8}</Link><IoIosArrowRoundForward />
                                    </div>
                                ) : (
                            ...
                            <div>
                                {isValidLink9 ? (
                                    <div className=" text-blue-600 border-b pb-3 w-fit flex items-center lg:text-xl font-semibold ">
                                        <Link href={link9}>{menu9}</Link><IoIosArrowRoundForward />
                                    </div>
                                ) : (
                            ...
                            <div>
                                {isValidLink10 ? (
                                    <div className=" text-blue-600 border-b pb-3 w-fit flex items-center lg:text-xl font-semibold ">
                                        <Link href={link10}>{menu10}</Link><IoIosArrowRoundForward />
                                    </div>
                                ) : (
                            ...
                            <div>
                                {isValidLink11 ? (
                                    <div className=" text-blue-600 border-b pb-3 w-fit flex items-center lg:text-xl font-semibold ">
                                        <Link href={link11}>{menu11}</Link><IoIosArrowRoundForward />
                                    </div>
                                ) : (
                            ...
                            <div>
                                {isValidLink12 ? (
                                    <div className=" text-blue-600 border-b pb-3 w-fit flex items-center lg:text-xl font-semibold ">
                                        <Link href={link12}>{menu12}</Link><IoIosArrowRoundForward />
                                    </div>
                                ) : (
                            ...
                            <div>
                                {isValidLink13 ? (
                                    <div className=" text-blue-600 border-b pb-3 w-fit flex items-center lg:text-xl font-semibold ">
                                        <Link href={link13}>{menu13}</Link><IoIosArrowRoundForward />
                                    </div>
                                ) : (
                            ...
                            <div>
                                {isValidLink14 ? (
                                    <div className=" text-blue-600 border-b pb-3 w-fit flex items-center lg:text-xl font-semibold ">
                                        <Link href={link14}>{menu14}</Link><IoIosArrowRoundForward />
                                    </div>
                                ) : (
                            ...
                            <div>
                                {isValidLink15 ? (
                                    <div className=" text-blue-600 border-b pb-3 w-fit flex items-center lg:text-xl font-semibold ">
                                        <Link href={link15}>{menu15}</Link><IoIosArrowRoundForward />
                                    </div>
                                ) : (
                            ...
                            <div>
                                {isValidLink16 ? (
                                    <div className=" text-blue-600 border-b pb-3 w-fit flex items-center lg:text-xl font-semibold ">
                                        <Link href={link16}>{menu16}</Link><IoIosArrowRoundForward />
                                    </div>
                                ) : (
                            ...
                            <div>
                                {isValidLink17 ? (
                                    <div className=" text-blue-600 border-b pb-3 w-fit flex items-center lg:text-xl font-semibold ">
                                        <Link href={link17}>{menu17}</Link><IoIosArrowRoundForward />
                                    </div>
                                ) : (
                            ...
                            <div>
                                {isValidLink18 ? (
                                    <div className=" text-blue-600 border-b pb-3 w-fit flex items-center lg:text-xl font-semibold ">
                                        <Link href={link18}>{menu18}</Link><IoIosArrowRoundForward />
                                    </div>
                                ) : (
