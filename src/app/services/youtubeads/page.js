...
export default function Home() {
  ...
  return (
    <div ClassName="flex flex-col ">
      <Navbar />
      <Banner
        mainhead="Best Youtube Ads Agency"
        maindesc="Optimizing YouTube Ads: Crafting Compelling Content and Targeting Strategies for Effective Audience Engagement."
      />
      <Proven
