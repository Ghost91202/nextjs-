...
export default function Home() {
  ...
  return (
    <div ClassName="flex flex-col ">
      <Navbar />
      <Banner
        mainhead="Best Social Media Marketing Agency"
        maindesc="Empowering Social Media Marketing: Integrating Data-Driven Strategies with Engaging Content for Enhanced Audience Reach and Engagement."
      />
      <Proven
